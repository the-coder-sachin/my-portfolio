...
const HomeContent = () => {
  return (
    <div className="w-full flex flex-col justify-center gap-5 px-8 lg:px-12 lg:pl-22">
      ...
      <div className="text-3xl">
        ...
        <p className="text-xs md:text-sm text-fuchsia-200 w-3/4">
      ...
      <div className="buttons flex items-center gap-4">
        <ButtonWhite>my projects</ButtonWhite>
        <ButtonTransparent>download CV</ButtonTransparent>
      </div>
      <div className="social-media-handles flex gap-5 pl-3">
